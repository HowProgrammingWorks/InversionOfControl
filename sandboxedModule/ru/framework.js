...
// Запись текста в файл <JustBestLogEver.log>
...
fs.readFile(fileName, function(err, src) {
    ...
    console.log('Exported function:\n'+
        'text' + fromSandbox.print.toString()+'params '+ fromSandbox.print.length);

    var after = Object.keys(sandbox);

    console.log('Keys from framework before start application:' +
        before + '\nKeys from framework after start application:' + after);
